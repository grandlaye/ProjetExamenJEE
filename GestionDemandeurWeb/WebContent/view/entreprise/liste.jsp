           ...
           <div class="col-md-12">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ajouter une Entrprise</h6>
                </div>
                <div class="card-body">
                	<form method="post" action="Entreprise">
	                  	<br/>
                	<h1>Editer Entreprise</h1>
	                      ...
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="nomEse" class="form-control" required="required" value='<c:if test="${entreprise!= null }">${entreprise.nomEse }</c:if>'/>
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          <label class="bmd-label-floating">Lieu de l'entreprise </label>
	                          <input type="text" name="lieu" class="form-control" required="required" value='<c:if test="${entreprise!= null }">${entreprise.lieu }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          <label class="bmd-label-floating">NINEA </label>
	                          <input type="text" name="codeNinea" class="form-control" required="required" value='<c:if test="${entreprise!= null }">${entreprise.codeNinea }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          <label class="bmd-label-floating">Email entreprise </label>
	                          <input type="text" name="email" class="form-control" required="required" value='<c:if test="${entreprise!= null }">${entreprise.email }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="password" name="password" class="form-control" required="required" value='<c:if test="${entreprise!= null }">${entreprise.password }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <c:if test="${entreprise != null }">
                    ...
                    <table class="table table-hover">
                    	...
                    	<c:forEach items="${entreprises }" var="c">
          					<tr>
          						...
          						<td><a href="Entreprise?action=edit&id=${c.id }">Modifier</a></td>
          					</tr>
          				</c:forEach>
                    </table>
                  </div>
