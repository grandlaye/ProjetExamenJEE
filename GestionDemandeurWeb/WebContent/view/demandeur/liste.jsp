                	...
                	<h1>Editer Entreprise</h1>
	                      ...
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="nom" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.nom }</c:if>'/>
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="prenom" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.prenom }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          <label class="bmd-label-floating">Email demandeur </label>
	                          <input type="text" name="email" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.email }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="password" name="password" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.password }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="addresse" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.addresse }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="tel" class="form-control" required="required" value='<c:if test="${demandeur!= null }">${demandeur.tel }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <c:if test="${demandeur != null }">
