           ...
           <div class="col-md-12">
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ajouter Utilisateur</h6>
                </div>
                <div class="card-body">
                	...
                	<h1>Editer User</h1>
	                      ...
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="hidden" name="id" class="form-control" value='${utilisateur.id }'/>
	                          </c:if>
	                          <input type="text" name="nom" class="form-control" required="required" value='<c:if test="${utilisateur!= null }">${utilisateur.nom }</c:if>'/>
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="prenom" class="form-control" required="required" value='<c:if test="${utilisateur!= null }">${utilisateur.prenom }</c:if>' />
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="text" name="email" class="form-control" required="required" value='<c:if test="${utilisateur!= null }">${utilisateur.email }</c:if>'/>
	                        </div>
	                      </div>
	                    </div>
	                    <div class="row">
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          ...
	                          <input type="password" name="password" class="form-control" required="required" value='<c:if test="${utilisateur!= null }">${utilisateur.password }</c:if>'/>
	                        </div>
	                      </div>
	                    </div>
	                    <c:if test="${utilisateur != null }">
