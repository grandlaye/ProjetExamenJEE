            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">A prpos</a></li>
	                      ...
	                      <div class="col-md-12">
	                        <div class="form-group">
	                          <label class="bmd-label-floating">Offre </label>
	                           <select  name="offre"class="form-control" required="required" value='<c:if test="${cvdemandeur!= null }">${cvdemandeur.entreprise }</c:if>'/>
	                          	<option value=""> Faites votre choix </option>
